		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class="active"><a href="erkek.php">Erkek</a></li>
		...
		<ul class="thumbnails">
			<li class="span4">
			  <div class="thumbnail">
				...
				<a href="deneme.php"><img src="assets/img/e7.jpg" alt="" width="270px"></a>
			...
			<li class="span4">
			  <div class="thumbnail">
				<a href="deneme.php" class="overlay"></a>
				<a class="zoomTool" href="deneme.php" title="add to cart"><span class="icon-search"></span> Denemek İçin</a>
				<a href="deneme.php"><img src="assets/img/e1.jpg" alt=""></a>
				<div class="caption cntr">
					<p>Glasses</p>
					<p><strong> $22.00</strong></p>
					<h4><a class="shopBtn" href="sepet.php" title="add to cart"> Sepete Ekle </a></h4>
			...
			<li class="span4">
			  <div class="thumbnail">
				<a href="deneme.php" class="overlay"></a>
				<a class="zoomTool" href="deneme.php" title="add to cart"><span class="icon-search"></span> Denemek İçin</a>
				<a href="deneme.php"><img src="assets/img/e2.jpg" alt=""></a>
				<div class="caption cntr">
					<p>Glasses</p>
					<p><strong> $22.00</strong></p>
					<h4><a class="shopBtn" href="sepet.php" title="add to cart"> Sepete Ekle </a></h4>
		...
		<ul class="thumbnails">
			<li class="span4">
			  <div class="thumbnail">
				<a href="deneme.php" class="overlay"></a>
				<a class="zoomTool" href="deneme.php" title="add to cart"><span class="icon-search"></span> Denemek İçin</a>
				<a href="deneme.php"><img src="assets/img/e3.jpg" alt="" ></a>
				<div class="caption cntr">
					<p>Glasses</p>
					<p><strong> $22.00</strong></p>
					<h4><a class="shopBtn" href="sepet.php" title="add to cart"> Sepete Ekle </a></h4>
			...
			<li class="span4">
			  <div class="thumbnail">
				<a href="deneme.php" class="overlay"></a>
				<a class="zoomTool" href="deneme.php" title="add to cart"><span class="icon-search"></span> Denemek İçin</a>
				<a href="deneme.php"><img src="assets/img/e4.jpg" alt="" width="270px"></a>
				<div class="caption cntr">
					<p>Glasses</p>
					<p><strong> $22.00</strong></p>
					<h4><a class="shopBtn" href="sepet.php" title="add to cart"> Sepete Ekle </a></h4>
			...
			<li class="span4">
			  <div class="thumbnail">
				<a href="deneme.php" class="overlay"></a>
				<a class="zoomTool" href="deneme.php" title="add to cart"><span class="icon-search"></span> Denemek İçin</a>
				<a href="deneme.php"><img src="assets/img/e6.jpg" alt="" width="270px"></a>
