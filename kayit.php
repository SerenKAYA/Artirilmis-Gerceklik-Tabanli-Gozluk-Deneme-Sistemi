...
-->
	...
	<form  action="islem.php" method="POST" class="form-horizontal">
		...
		<div class="controls">
			 <input type="text" id="inputFname" name="uye_cinsiyet" placeholder="Cinsiyetiniz">
		</div>
		</div>
		<div class="control-group">
			<label class="control-label"  for="inputFname">Adınız </label>
			<div class="controls">
			  <input type="text" id="inputFname" name="uye_adi" placeholder="Adınız">
			</div>
		 </div>
		 <div class="control-group">
			<label class="control-label"  for="inputLname">Soyadınız </label>
			<div class="controls">
