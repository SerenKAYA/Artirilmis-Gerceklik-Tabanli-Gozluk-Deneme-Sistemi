 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="POST" action="islem.php=<?php echo $row["urun_id"]; ?>">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                               <img src="<?php echo $row["urun_resim"]; ?>" class="img-responsive" /><br />  
                               <h4 class="text-info"><?php echo $row["urun_adi"]; ?></h4>  
                               <h4 class="text-danger">$ <?php echo $row["urun_fiyat"]; ?></h4>  
